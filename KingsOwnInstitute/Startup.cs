...
namespace KingsOwnInstitute
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISeminarTypeService, SeminarTypeService>();
            services.AddScoped<ISeminarsService, SeminarsService>();
            services.AddScoped<ISeminarOrganizersService, SeminarOrganizersService>();
            services.AddScoped<IRegistrationInfoService, RegistrationInfoService>();
        }
